...
int main()
{
	...
	std::cout<<"science is real"<<std::endl;
	SparseMatrix<double> Laplacian = getLaplacian("/home/ruofeng/cluster/data/6473.edges",0,false);
	...
	*/
    ...
    //PCG(R,b,Solve_Jacobian,1000,1e-9);
    //sol.Print("sol:");
	/**
